...
<html lang="en">
<head>
    <title>Code coverage report for restrict-to-roles.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> restrict-to-roles.js
    </h1>
    <div class='clearfix'>
...
105
106
107</td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
&nbsp;
    ...
    if (options.owner &amp;&amp; !authorized) {
      <span class="missing-if-branch" title="if path not taken" >I</span>if (hook.id === null) {
<span class="cstat-no" title="statement not covered" >        throw new errors.BadRequest('Can not verify roles when changing many resources.');</span>
      }
&nbsp;
      if (!hook.id) {
...
<span class="cstat-no" title="statement not covered" >          field = get(field, options.idField);</span>
        }
&nbsp;
