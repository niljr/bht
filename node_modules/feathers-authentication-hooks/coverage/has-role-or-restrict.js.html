...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (hook.method !== 'find' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >hook.method !== 'get') {</span>
...
&nbsp;
      return hook.service.find(Object.assign({}, params, { query })).then(results =&gt; {
        <span class="missing-if-branch" title="if path not taken" >I</span>if (hook.method === 'get' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >Array.isArray(results) &amp;&amp; <span class="branch-2 cbranch-no" title="branch not covered" >results.length === 1) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      return hook.service.find(Object.assign({}, params, { query })).then(<span class="fstat-no" title="function not covered" >results =&gt; </span>{</span>
