...
<html lang="en">
<head>
    <title>Code coverage report for restrict-to-owner.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> restrict-to-owner.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!(hook.method === 'get' || <span class="branch-1 cbranch-no" title="branch not covered" >hook.method === 'update' || <span class="branch-2 cbranch-no" title="branch not covered" >hook.method === 'patch' || <span class="branch-3 cbranch-no" title="branch not covered" >hook.method === 'remove')) {</span></span></span>
<span class="cstat-no" title="statement not covered" >      throw new errors.MethodNotAllowed(`The 'restrictToOwner' hook should only be used on the 'get', 'update', 'patch' and 'remove' service methods.`);</span>
    }
&nbsp;
    if (!hook.params.user) {
...
&nbsp;
      <span class="missing-if-branch" title="if path not taken" >I</span>if (Array.isArray(field)) {
        const fieldArray = <span class="cstat-no" title="statement not covered" >field.map(<span class="cstat-no" title="statement not covered" ><span class="fstat-no" title="function not covered" >idValue =&gt; idValue.toString());</span></span></span>
<span class="cstat-no" title="statement not covered" >        if (fieldArray.length === 0 || fieldArray.indexOf(id.toString()) &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >          throw new errors.Forbidden('You do not have the permissions to access this.');</span>
        }
...
<div class='footer quiet pad2 space-top1 center small'>
  Code coverage
  generated by <a href="https://istanbul.js.org/" target="_blank">istanbul</a> at Wed Feb 21 2018 19:50:30 GMT-0800 (PST)
</div>
</div>
