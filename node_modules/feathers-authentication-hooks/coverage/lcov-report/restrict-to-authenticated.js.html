...
<html lang="en">
<head>
    <title>Code coverage report for restrict-to-authenticated.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> restrict-to-authenticated.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
export default function (options = { entity: 'user' }) <span class="branch-1 cbranch-no" title="branch not covered" ><span class="branch-0 cbranch-no" title="branch not covered" >{</span></span>
